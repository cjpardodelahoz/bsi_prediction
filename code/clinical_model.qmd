...
I will split the data into training and testing subsets by sampling the patients instead of the individual data points. I will use 70% of the patients for training and 30% for testing:
...
train_patients_nm <- sample(patients_nm, size = floor(0.7 * length(patients_nm)))
