...
#SBATCH --output=log/bacteroides_variation/yan_sd_2022_vamb_single_%A_%a.out
#SBATCH --error=log/bacteroides_variation/yan_sd_2022_vamb_single_%A_%a.err
...
OUTPUT_DIR="analyses/yan_sd_2022/binning/vamb/single"
...
# Step 2: Run VAMB
vamb bin default --fasta ${ASSEMBLY} \
