...
awk 'NR!=2035 && NR!=1880 && NR!=1655 && NR!=1640 && NR!=1530 && NR!=1063 && NR!=63 && NR!=40' \
  misc_files/bacteroides_pul/isabl1_succesful_assemblies.txt > misc_files/bacteroides_pul/isabl1_succesful_pulpredictions.txt
...
```{bash, eval=FALSE}
sbatch code/scripts/bacteroides_pul/isabl1_mags_signalp_1-9999.sh # 6471842
sbatch code/scripts/bacteroides_pul/isabl1_mags_signalp_10000-10360.sh
```
