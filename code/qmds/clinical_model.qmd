...
tblwbc <- suppressMessages(read_csv("data/tblwbc.csv")) %>%
    ...
    mutate(clinical_phase = case_when(
                ...
                Status %in% c("NeutropeniaStart", "Neutropenia", "TransitionToEngraftment") | is.na(Status) ~ "Neutropenia",
...
tblpatientday_clinical <- tblpatientday %>%
    ...
    mutate(
        ...
        Proteobacteria_infection = if_any(all_of(proteobacteria), ~ .x == 1),
