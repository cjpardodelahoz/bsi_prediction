...
#SBATCH --output=log/bacteroides_variation/bacteroides_vamb_single_%A_%a.out
#SBATCH --error=log/bacteroides_variation/bacteroides_vamb_single_%A_%a.err
#SBATCH --time=48:00:00
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --partition=cpu

# Activate the VAMB environment
...
OUTPUT_DIR="analyses/bacteroides_variation/binning/vamb/single"
...
vamb bin default \
    --fasta ${ASSEMBLY} \
    --bamdir ${SAMPLE_BAM_DIR} \
    --outdir ${OUTPUT_DIR}/${sample_name}/out \
    --minfasta 250000 \
    -m 1000 \
    -p 16
