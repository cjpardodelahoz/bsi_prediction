...
#SBATCH --output=log/bacteroides_variation/yan_sd_2022_gtdb.out
#SBATCH --error=log/bacteroides_variation/yan_sd_2022_gtdb.err
...
OUTPUT_DIR="analyses/yan_sd_2022/binning/gtdb"
