...
#SBATCH --array=1-49%5  # Adjust the range based on the number of patient sample files
#SBATCH --output=log/bacteroides_variation/bacteroides_vamb_multi_%A_%a.out
#SBATCH --error=log/bacteroides_variation/bacteroides_vamb_multi_%A_%a.err
...
BINNING_DIR="analyses/bacteroides_variation/binning"
PATIENT_SAMPLES_DIR="analyses/yan_sd_2022/binning/patient_samples"
