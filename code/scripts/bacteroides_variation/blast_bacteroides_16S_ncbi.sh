...
#SBATCH --error=log/bacteroides_variation/blast_meta_to_ncbi.err
#SBATCH --output=log/bacteroides_variation/blast_meta_to_ncbi.out
...
# Set paths
QUERY_FASTA="analyses/bacteroides_variation/16S/compiled/bacteroides_16S.fasta"
CHUNK_DIR="analyses/bacteroides_variation/16S/compiled/chunks"
RESULTS_DIR="analyses/bacteroides_variation/16S/compiled/chunk_results"
MERGED_RESULTS="analyses/bacteroides_variation/16S/compiled/bacteroides_ncbi_blast.txt"
...
seqkit split -p 15 -O ${CHUNK_DIR} ${QUERY_FASTA}
...
echo "All chunks processed and merged into ${MERGED_RESULTS}."