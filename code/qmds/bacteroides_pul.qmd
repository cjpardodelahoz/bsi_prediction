...
target_families <- c("Bacteroidaceae", "Barnesiellaceae", "Dysgonomonadaceae", "Marinifilaceae", "Rikenellaceae", "Tannerellaceae")
...
# Plot (log odds ratio)
bacteroidota_detection <- ggplot(prevalence_effects, aes(x = factor(family, levels = c("Bacteroidaceae", "Tannerellaceae", "Rikenellaceae", "Barnesiellaceae", "Marinifilaceae", "Dysgonomonadaceae")), y = estimate, ymin = conf.low, ymax = conf.high)) +
...
bacteroidota_fam_abund <- ggplot(patient_medians, 
  aes(x = factor(family,levels = c("Bacteroidaceae", "Tannerellaceae", "Rikenellaceae", "Barnesiellaceae", "Marinifilaceae", "Dysgonomonadaceae")),
