...
#SBATCH --array=1-210,212-366,368-395%20  # Adjust the range based on the number of samples
#SBATCH --mem-per-cpu=8G
#SBATCH -c 2
#SBATCH --time=24:00:00
#SBATCH --error=log/bacteroides_variation/extract_meta_16S_%A_%a.err
#SBATCH --output=log/bacteroides_variation/extract_meta_16S_%A_%a.out
...
OUTPUT_DIR="analyses/bacteroides_variation/16S/meta"
...
echo "16S extraction completed for sample: ${sample_name}"