...
#SBATCH --output=log/bacteroides_variation/yan_sd_2022_filter_contigs_%A_%a.out
#SBATCH --error=log/bacteroides_variation/yan_sd_2022_filter_contigs_%A_%a.err
